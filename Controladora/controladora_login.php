...
class ControladoraLogin
{
	...
	public function validarUsuario($usuario, $pass)
	{
		...
		{
			$this->SqlQuery = '';
			$this->SqlQuery = "SELECT per.uid, per.per_sermail, con.conusu_scontrasena FROM Personal per, Contrasena con WHERE per.per_uid = con.conusu_uid AND per.per_sermail = ?";
